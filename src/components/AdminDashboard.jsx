...
// je commente pour tester le bordure
...
//   );
// }
//  je commente pour tester la recuperation des produits
// import React, { useState } from 'react';
// import AjouterProduit from './AjouterProduit';
// import ModifierProduit from './ModifierProduit';
// import SupprimerProduit from './SupprimerProduit';
...
//           Ajouter un produit
//         </button>
//         <button onClick={() => setAction('modifier')} style={{ marginRight: '1rem', color: '#fff' , backgroundColor: 'blue'}}>
//           Modifier un produit
//         </button>
//         <button onClick={() => setAction('supprimer')} style={{ backgroundColor: 'red', color: '#fff' }}>
//           Supprimer un produit
//         </button>
//       </div>
...
//           style={{ backgroundColor: '#333', color: '#fff', padding: '0.7rem 1.5rem', borderRadius: '5px' }}
//         >
//           Afficher les produits déjà ajoutés
//         </button>
//       </div>
...
//                       {produit.imageUrl ? (
//                         <img src={produit.imageUrl} alt={produit.nom} style={{ width: '80px', height: '80px', objectFit: 'cover' }} />
//                       ) : (
